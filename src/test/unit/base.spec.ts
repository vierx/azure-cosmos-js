...
describe("Base", function() {
    ...
    describe("#.getAttachmentIdFromMediaId", function() {
        const test = (input: string, expected: string) => {
            assert.strictEqual(
                Base.getAttachmentIdFromMediaId(input),
                expected
            );
        };
        ...
        it("> 20 characters, Multiple hyphens '-'", function() {
            test(
                "6hl2ALdWb-CxAgAAAAAAAC4-1VoB",
                "6hl2ALdWb-CxAgAAAAAAAC4-1Vo="
            );
        });
    ...
    describe("#.parsePath", function() {
        const test = (input: string, expected: any) => {
            assert.strictEqual(
                JSON.stringify(Base.parsePath(input)),
