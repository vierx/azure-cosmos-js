...
export class Container {
    ...
    public async read(options?: RequestOptions): Promise<ContainerResponse> {
        const response = await this.database.client.documentClient.readCollection(
            this.url,
            options
        );
        return {
    ...
    public async replace(
        ...
        const response = await this.database.client.documentClient.replaceCollection(
            this.url,
            body,
            options
        );
    ...
    public async delete(options?: RequestOptions): Promise<ContainerResponse> {
        const response = await this.database.client.documentClient.deleteCollection(
            this.url,
            options
        );
        return {
