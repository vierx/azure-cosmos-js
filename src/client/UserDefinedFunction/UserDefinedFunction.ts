...
export class UserDefinedFunction {
    public get url() {
        return UriFactory.createUserDefinedFunctionUri(
    ...
    public read(
        ...
        return this.client.documentClient.readUserDefinedFunction(
            this.url,
            options
        );
    }
    ...
    public replace(
        ...
        return this.client.documentClient.replaceUserDefinedFunction(
            this.url,
            body,
            options
        );
    ...
    public delete(
        ...
        return this.client.documentClient.deleteUserDefinedFunction(
            this.url,
            options
        );
    }
