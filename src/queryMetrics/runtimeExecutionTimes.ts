...
export class RuntimeExecutionTimes {
    ...
    public static createFromArray(
        ...
        if (runtimeExecutionTimesArray == null) {
            throw new Error(
                "runtimeExecutionTimesArray is null or undefined item(s)"
            );
        }
    ...
    public static createFromDelimitedString(delimitedString: string) {
        ...
        const vmExecutionTime = QueryMetricsUtils.timeSpanFromMetrics(
            metrics,
            QueryMetricsConstants.VMExecutionTimeInMs
        );
        const indexLookupTime = QueryMetricsUtils.timeSpanFromMetrics(
            metrics,
            QueryMetricsConstants.IndexLookupTimeInMs
        );
        const documentLoadTime = QueryMetricsUtils.timeSpanFromMetrics(
            metrics,
        ...
        queryEngineExecutionTime = queryEngineExecutionTime.subtract(
            indexLookupTime
        );
        queryEngineExecutionTime = queryEngineExecutionTime.subtract(
            documentLoadTime
